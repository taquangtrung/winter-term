...
/// A rasterized top-tabbar strip: its pixels and their dimensions. Unlike a
/// dropdown it carries no position, because the strip always sits at the
/// surface's top-left corner.
pub(crate) struct StripImage {
